...
# Read accuracy data
run = '2'
shape_accuracy = read_accuracy('./mlruns/SDIM/run' + run + '/metrics/shape_accuracy')
scale_accuracy = read_accuracy('./mlruns/SDIM/run' + run + '/metrics/scale_accuracy')
orientation_accuracy = read_accuracy('./mlruns/SDIM/run' + run + '/metrics/orientation_accuracy')
x_floor_hue_accuracy = read_accuracy('./mlruns/SDIM/run' + run + '/metrics/x_floor_hue_accuracy')
x_wall_hue_accuracy = read_accuracy('./mlruns/SDIM/run' + run + '/metrics/x_wall_hue_accuracy')
x_object_hue_accuracy = read_accuracy('./mlruns/SDIM/run' + run + '/metrics/x_object_hue_accuracy')
...
x_floor_hue_accuracy = read_accuracy('./mlruns/EDIM/run' + run + '/metrics/x_floor_hue_accuracy')
x_wall_hue_accuracy = read_accuracy('./mlruns/EDIM/run' + run + '/metrics/x_wall_hue_accuracy')
x_object_hue_accuracy = read_accuracy('./mlruns/EDIM/run' + run + '/metrics/x_object_hue_accuracy')
