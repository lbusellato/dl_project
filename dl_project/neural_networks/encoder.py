...
class BaseEncoder(nn.Module):
    def __init__(
        ...
        feature_map_size = (img_size - kernel_size + 1) // 2  # After conv2
        feature_map_size = (feature_map_size - kernel_size + 1) // 2  # After conv3       
        self.dense = nn.Linear(
            in_features=(feature_map_size ** 2) * (num_filters * 2 ** 2),
